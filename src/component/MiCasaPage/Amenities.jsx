...
const Amenities = () => {
    ...
    return (
        <section className="relative w-full flex flex-col items-center justify-center py-16 px-6 ">
            <h1 className="text-3xl md:text-6xl font-serif italic pb-12 text-gray-700 leading-tight text-center">
                Amenities
            </h1>
            {/* The Amenities Card */}
            <div className="w-full max-w-7xl p-6 md:p-10 mt-15 rounded-3xl backdrop-blur-md bg-gradient-to-br from-white/60 to-white/30 border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.15)] z-10">
